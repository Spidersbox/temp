...
// by Simone: at one point, these will all need to be changed into HamstersDB, but we need most of the network to be already on HamstersDB
// otherwise it will make a hard fork !
#if defined(__arm__)
const std::string CLIENT_NAME("HamstersDB-ARM");
const std::string CLIENT_NAME_NEW("HamstersDB-ARM");
#else
const std::string CLIENT_NAME("HamstersDB");
const std::string CLIENT_NAME_NEW("HamstersDB");
#endif
