...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "HamstersDB.lnk";
}
...
{
    return GetAutostartDir() / "HamstersDB.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("HamstersDB-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  HamstersDB-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("HamstersDB-Qt"));
