...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    ui->lblGraphRange->setText(GUIUtil::formatDurationStr(30 * 60));
    if(model)
    {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the HamstersDB RPC console.") + "<br>" +
...
void RPCConsole::updateNodeDetail(const CNodeCombinedStats *stats)
{
    ...
    ui->peerPingMin->setText(GUIUtil::formatPingTime(stats->nodeStats.dPingMin));
    ui->peerPingWait->setText(GUIUtil::formatPingWaitTime(stats->nodeStats.dPingWait));
