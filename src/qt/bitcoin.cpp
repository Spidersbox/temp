    ...
    QWidget(parent, f)
{
	...
	QLabel *l = new QLabel();
	setWindowTitle(tr("HamstersDB"));
	QString s = tr("HamstersDB Wallet is shutting down, please wait...") + "<br><br>" + tr("DO NOT shutdown the computer until this window disappears");
	l->setText(s);
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. HamstersDB can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// by Simone: still allow compiling even with QT4
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "HamstersDB",
    ...
    app.setOrganizationName("HamstersDB");
    app.setOrganizationDomain("HamstersDB.su");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("HamstersDB-Qt-testnet");
    else
        app.setApplicationName("HamstersDB-Qt");
