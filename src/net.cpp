...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("HamstersDB-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "HamstersDB " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][4] = {
	...
	{"HamstersDB.co", "HamstersDB.co"},
    {"spb.altcoinwarz.com", "spb.altcoinwarz.com"},
	{"seed.HamstersDB.co", "seed.HamstersDB.co"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("HamstersDB-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("HamstersDB-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("HamstersDB-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("HamstersDB-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. HamstersDB is probably already running."), addrBind.ToString().c_str());
        else
